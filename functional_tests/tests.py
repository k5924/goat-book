...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ## We delete al the browser's cookies
        ## as a way of simulating a brand new user session
        self.browser.delete_all_cookies()

        # Francis visists the home page. There is no sign of Ediths
        # list
        self.browser.get(self.live_server_url)
        ...
        # He is less interesing that Edith..
        self.create_entry_in_list("Buy milk")
